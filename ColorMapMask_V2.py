...
def MrSifter(root_dir):
	...
	for root, dirs, files in os.walk(root_dir):
		...
		for file in files:
			if file.endswith("_NewResults.csv"):
...
def TemplateArray(image):
	...
	## of the filter image
	X = cut_filter*X-cut_off_x # Change for right side image, # *X for right side, * X-cut_off_x for left
...
if __name__ == '__main__':
	...
	Image = cv2.imread("C:\\Users\\caitl\\Documents\\Tomograms\\HalfSample\\50Both_Height\\Left\\Sample_045_1.tif", 0)
	...
	plot_file = "C:\\Users\\caitl\\Documents\\Tomograms\\HalfSample\\50Both_Height\\Left\\"
	plt.savefig(plot_file + "Sample_045_1_Mask_Nov19.pdf")
	plt.show()